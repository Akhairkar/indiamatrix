...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const handleSend = async () => {
    ...
    try {
      // WARNING: Do not put your actual Gemini API key here!
      // Update this URL to point to your deployed Cloudflare Worker (see workers/gemini/index.js)
      const GEMINI_API_URL = "https://your-worker-name.your-subdomain.workers.dev/";
